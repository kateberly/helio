...
c      data thresh/0.0/,rf/.1/,h/.05/,logs/.true./,nfunc/2/
     ...
     +win/1690000*0.0/,isnet/.false./,thresh/0.0/,rf/.1/,h/.05/,
     +logs/.true./,nfunc/2/
      on=1.0
      off=-1.0
...
c
      open(unit=1,file='catpac/runner/exclude.dat'
...
c
  ...
  17  FORMAT('  TOTAL WORDS          ',I8,8X,'THRESHOLD',11x,F5.3/
     +       '  TOTAL UNIQUE WORDS   ',I8,8X,'RESTORING FORCE',5x,F5.3/
